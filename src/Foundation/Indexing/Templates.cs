    ...
    public struct Templates
    {
        public struct SearchSettings
        {
            ...
            public struct Fields
            {
                ...
                public static readonly ID TargetTemplates = new ID("{2AD3D76D-4348-4D23-9988-A1E0CF9C2D0F}");
                public static readonly ID PageSize = new ID("{2451C71D-4BCA-480E-875D-456C31DF189C}");
